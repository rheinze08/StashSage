...
Feature Importances:
 1) Quality (pattern: Quality)                         importance=0.11087
 2) f36 (pattern: #% to lightning resistance)          importance=0.10699
 3) f34 (pattern: #% to cold resistance)               importance=0.10197
 4) f33 (pattern: #% to chaos resistance)              importance=0.07864
 5) f20 (pattern: #% increased evasion rating)         importance=0.07703
 6) f8 (pattern: # to maximum life)                    importance=0.07640
 7) f5 (pattern: # to evasion rating)                  importance=0.07573
 8) f35 (pattern: #% to fire resistance)               importance=0.07388
 9) f9 (pattern: # to spirit)                          importance=0.05699
10) Deflated_Evasion (pattern: Deflated_Evasion)       importance=0.04569
11) f1 (pattern: # life regeneration per second)       importance=0.04032
12) f4 (pattern: # to dexterity)                       importance=0.02791
13) f28 (pattern: #% reduced bleeding duration on you) importance=0.02536
14) f31 (pattern: #% reduced slowing potency of debuffs on you) importance=0.02428
15) f2 (pattern: # to # physical thorns damage)        importance=0.01833
16) f11 (pattern: # to stun threshold)                 importance=0.01702
17) f30 (pattern: #% reduced poison duration on you)   importance=0.01478
18) f17 (pattern: #% increased elemental ailment threshold) importance=0.01292
19) f27 (pattern: #% reduced attribute requirements)   importance=0.00599
20) extra_socket_mod (pattern: extra_socket_mod)       importance=0.00407
21) Corrupted_Flag (pattern: Corrupted_Flag)           importance=0.00280
22) f29 (pattern: #% reduced ignite duration on you)   importance=0.00202
