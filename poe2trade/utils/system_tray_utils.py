...
try:
    ...
    import win32con
    import win32gui
except ImportError:  # pywin32 ships on Windows only; the tray is a Windows-only feature.
    win32api = win32con = win32gui = None

TRAY_NOTIFY_ID = 1028
WM_NOTIFY_ICON = (win32con.WM_USER + 20) if win32con is not None else None
